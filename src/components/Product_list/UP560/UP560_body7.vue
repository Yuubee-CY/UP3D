<template>
  <div class="UP560_Body7">
    ...
    <iframe id="video" v-show="currentVideo" src="https://www.youtube.com/embed/m3j0546HxhY"
...
export default {
  ...
  watch: {
    ...
    '$store.state.lang': function () {
      ...
      this.playflag = 0;
      document.querySelector('.UP560_Body7 .bg').style.backgroundImage = "url(" + this.lang2.media.videoBg + ")";
...
.UP560_Body7 .bg .content {
  position: relative;
}


.UP560_Body7 .bg .content p {
  font-weight: lighter;
  position: absolute;
  top: 1.052083rem;
  left: 3.046875rem;
...
@media (max-width: 576px) {
  ...
  .UP560_Body7 video,iframe,.ct-video {
    width: 100%;
    height: 100%;
  }
