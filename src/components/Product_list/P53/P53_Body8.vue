<template>
  <div class="P53_Body8">
    ...
    <iframe id="video" v-show="currentVideo" src="https://www.youtube.com/embed/jy3P-FTPKr4"
...
export default {
  ...
  watch: {
    ...
    '$store.state.lang': function () {
      ...
      this.playflag = 0;
      document.querySelector('.P53_Body8 .bg').style.backgroundImage = "url(" + this.lang2.media.videoBg + ")";
...
.P53_Body8 .bg .content {
  position: relative;
}


.P53_Body8 .bg .content p {
  font-weight: lighter;
  position: absolute;
  top: 1.052083rem;
  left: 3.046875rem;
